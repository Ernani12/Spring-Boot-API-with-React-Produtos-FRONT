function Formulario ({botao,eventoTeclado,alterar, cadastrar,cancelar, objLimpar, remover}){
    return (
        ...
        <form>
            ...
            
            {
                ...
                :
                <div>
                    <input type="button"  onClick={alterar} value="Alterar"className="btn-warning"></input>
